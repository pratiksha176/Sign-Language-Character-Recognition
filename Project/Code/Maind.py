...
class Dashboard(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        cv2.destroyAllWindows()
        self.setWindowIcon(QtGui.QIcon('C:/Users/prati/OneDrive/Desktop/SLR/Source Code/icons/windowLogo.png'))
        self.title = 'Sign language Character Recognition'
        uic.loadUi('C:/Users/prati/OneDrive/Desktop/SLR/Source Code/UI_Files/dash.ui', self)
        ...
        movie = QtGui.QMovie("C:/Users/prati/OneDrive/Desktop/SLR/Source Code/icons/dashAnimation.gif")
    ...
    def createGest(self):
        ...
        try:
            ...
            pass
        gesname = ""
        uic.loadUi('C:/Users/prati/OneDrive/Desktop/SLR/Source Code/UI_Files/create_gest.ui', self)
        self.setWindowTitle(self.title)
        self.create.clicked.connect(self.createGest)
        self.exp2.clicked.connect(self.exportFile)
    ...
    def exportFile(self):
        ...
        try:
            ...
            pass
        uic.loadUi('C:/Users/prati/OneDrive/Desktop/SLR/Source Code/UI_Files/export.ui', self)
        self.setWindowTitle(self.title)
        self.create.clicked.connect(self.createGest)
        self.exp2.clicked.connect(self.exportFile)
        self.scan_sen.clicked.connect(self.scanSent)
    ...
    def scanSent(self):
        ...
        try:
            ...
            pass
        uic.loadUi('C:/Users/prati/OneDrive/Desktop/SLR/Source Code/UI_Files/scan_sent.ui', self)
        self.setWindowTitle(self.title)
        self.create.clicked.connect(self.createGest)
        self.exp2.clicked.connect(self.exportFile)
        if (self.scan_sen.clicked.connect(self.scanSent)):
    ...
    def scanSingle(self):
        ...
        try:
            ...
            pass
        uic.loadUi('C:/Users/prati/OneDrive/Desktop/SLR/Source Code/UI_Files/scan_single.ui', self)
        self.setWindowTitle(self.title)
        self.create.clicked.connect(self.createGest)
        self.exp2.clicked.connect(self.exportFile)
        self.scan_sen.clicked.connect(self.scanSent)
